...
if (jQuery("#radar-multiple-chart").length) {
  var options = {
      ...
      xaxis: {
          categories: ['1402', '1399', '1389', '1390', '1401', '1400']
      }
  };
...
if(jQuery('#market-overview-chart').length){
    ...
    document
      ...
      .addEventListener('click', function(e) {
        ...
        chart.zoomX(
          new Date('28 آذر 1402').getTime(),
          new Date('27 آبان 1402').getTime()
        )
      })
    ...
    document
      ...
      .addEventListener('click', function(e) {
        ...
        chart.zoomX(
          new Date('27 اسفند 1402').getTime(),
          new Date('27 آبان 1402').getTime()
        )
      })
